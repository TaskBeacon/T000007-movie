...
| `movie` | `movie_playback` | `movie` | Continuous generated reference movie clip presented at center; participant watches passively. | `W2087530658` | Core task operation is passive viewing under continuous recording. | `generated_reference_asset` | `assets/reference_movie.mp4` | No trial-level choice or accuracy response is collected. |
